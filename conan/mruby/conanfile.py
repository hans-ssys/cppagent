...
class MRubyConan(ConanFile):
    ...
    def source(self):
        ...
        get(self, "http://chitin-rh/pub/mtconnect-src-mirror/mruby/3.2.0.zip", strip_root=True, destination=self.source_folder)
        get(self, "http://chitin-rh/pub/mtconnect-src-mirror/mattn/master.zip",
            strip_root=True, destination=os.path.join(self.source_folder, 'mrbgems', 'mruby-onig-regexp'))
